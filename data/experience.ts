...
export const experiences: ExperienceItem[] = [
  {
    ...
    growthScore: 7.8,
    growthHighlight:
      "Current leadership role focused on structured planning, execution tracking, and stakeholder communication.",
    headlineBullets: [
      "Lead planning and coordination of community-focused initiatives.",
      "Manage task allocation, milestone tracking, and stakeholder communication.",
      "Structure volunteer workflows and documentation for operational clarity.",
      "Define impact metrics and reporting for program tracking.",
    ],
    detailBullets: [
      "Own planning cadence and initiative sequencing across volunteer programs.",
      "Coordinate execution owners and maintain milestone accountability.",
      "Standardize workflow documentation and reporting formats.",
      "Track initiative progress through practical impact metrics.",
    ],
    tools: [t.jira, t.powerbi, t.confluence, t.agile],
    scopeStakeholders: [
      "Foundation leadership",
      "Volunteer contributors",
      "Community program stakeholders",
    ],
    programsClients: ["Nonprofit program delivery"],
    outcomes: [
      "Improved coordination rhythm across community initiatives.",
      "Established clearer task ownership and milestone visibility.",
      "Strengthened reporting structure for program impact tracking.",
    ],
    challengesResolutions: [
      "Distributed volunteer bandwidth -> structured task ownership and milestone cadence.",
      "Inconsistent workflow visibility -> introduced documentation templates and recurring reporting.",
    ],
  },
  {
    id: "exp-savvy",
